...
import { managementAIResponses } from "@/data/aiResponseData";
...
const ManagementPage = () => {
	...
	const pendingAIResponses = managementAIResponses.filter(
		(r) => r.status === "pending",
	).length;
		...
		<div className="space-y-6">
			...
			{activeTab === "ai" ? (
				<PageSpecificAIManager
					...
					pageType="management"
					title="관리 AI 응답 관리"
					description="편입 일정 문의 및 학습 관련 질문에 대한 AI 자동응답을 관리합니다"
				/>
			) : (
				<>
					{/* Search & Filter */}
